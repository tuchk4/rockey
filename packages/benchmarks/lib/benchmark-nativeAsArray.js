...
const bestResultsPath = path.join(
  __dirname,
  'bestResults',
  'results-nativeAsArray.json'
);

const currentResultsPath = path.join(__dirname, 'results-nativeAsArray.json');
...
const modules = ['rockey', 'css', 'peg', 'stylis', 'postcss', 'postcssSafe'];

console.log('');
console.log('Benchmark Native As Array');
