...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
    ...
    peg$c251 = function(string) {
      return string;
    },
    peg$c252 = peg$otherExpectation('identifier'),
    peg$c253 = function(ident) {
      return ident;
    },
